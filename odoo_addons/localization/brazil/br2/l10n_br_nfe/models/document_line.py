...
> <det>
    ...
    def _prepare_import_dict(self, values, model=None, parent_dict=None, defaults_model=None):
        ...
        if not values.get("name"):
            ...
            if values.get("product_id"):
                values["ncm_id"] = (self.env["product.product"].browse(values["product_id"]).ncm_id.id)
        return values
    ...
    def _export_fields(self, xsd_fields, class_obj, export_dict):
        ...
        self.nfe40_rastro = self._export_rastro()
        self.nfe40_DI = self._export_DI()
        
        
        
        return super()._export_fields(xsd_fields, class_obj, export_dict)

    def _export_rastro(self):
        res = [(5,)]
        for lot in self.lot_ids: 
            
            var = {
                
                'nfe40_rastro_prod_id': self.id,
                'nfe40_nLote': lot.name,
                'nfe40_qLote': lot.product_qty,
                'nfe40_dFab': lot.manufacture_date,
                'nfe40_dVal': lot.expiration_date,
                'nfe40_cAgreg': False,
            }
            res += [(0,0,var)]
    ...
    def _export_DI(self):
        ...
        for n in self.nDI_value: 
            
            var = {
           
            'nfe40_nDI' : n.nDI, 
            'nfe40_dDI': n.dDI,
            # 'nfe40_dDesemb': n.dDesemb,
            'nfe40_UFDesemb': n.UFDesemb,
            'nfe40_xLocDesemb': n.xLocDesemb,
            # 'nfe40_cExportador' : n.cExportador,
            # 'nfe40_vAFRMM': False,
            'nfe40_tpViaTransp' : n.tpViaTransp,
            # 'nfe40_tpIntermedio' : n.tpIntermedio,
            # 'nfe40_adi': [(0,0,{
            # 'nfe40_cFabricante' : n.cFabricante,
            # 'nfe40_nAdicao': n.nAdicao,
            # 'nfe40_nSeqAdic' : n.nSeqAdic
            # }
            # )]
            #
        ...
        # self.nfe40_DI.nfe40_adi.create({
        #     'nfe40_cFabricante' : n.cFabricante,
        #     'nfe40_nAdicao': n.nAdicao,
        #     'nfe40_nSeqAdic' : n.nSeqAdic
        # })
