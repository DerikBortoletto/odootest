...
class AccountMoveLine(models.Model):
    ...
    def write(self, values):
        ...
        if any(field in values.keys() for field in MOVE_LINE_FIELDS):
            ...
            for invoice in invoices.filtered(lambda i: i.fiscal_document_id.id != i.company_id.fiscal_dummy_id.id
                ...
                if invoice.processador_edoc in [PROCESSADOR_OCA,PROCESSADOR_TRUST]:
