...
CSOSN_ICMSSN101 = [
    ("101", "101- Tributada pelo Simples Nacional com permissão de crédito (v.2.0)."),
]
...
CSOSN_ICMSSN202 = [
    ...
    ("203", "203- Isenção do ICMS nos Simples Nacional para faixa de receita "
     "bruta e com cobrança do ICMS por Substituição Tributária (v.2.0)"),
]
...
# (v.2.0)
CSOSN_ICMSSN500 = [
    ("500", "500 – ICMS cobrado anterirmente por substituição tributária"
            "(substituído) ou por antecipação (v.2.0)"),
]

# Tributação pelo ICMS 900 - Outros(v2.0)
CSOSN_ICMSSN900 = [
    ("900", "900 Tributação pelo ICMS 900 - Outros(v2.0)"),
]
...
TORIG = [
    ...
    ("6", "6-Estrangeira - Importação direta, com similar nacional, lista CAMEX"),
...
INDTOT_PROD = [
    ("0", "0 – o valor do item (vProd) não compõe o valor total da NF-e (vProd)"),
...
class TLocal(models.AbstractModel):
    ...
    nfe40_choice2 = fields.Selection([('nfe40_CNPJ', 'CNPJ'),('nfe40_CPF', 'CPF')],"CNPJ/CPF")
    nfe40_CNPJ = fields.Char(choice='2', string="CNPJ", xsd_required=True, xsd_type="TCnpjOpc")
    nfe40_CPF = fields.Char(choice='2', string="CPF (v2.0)", xsd_required=True, xsd_type="TCpf")
    nfe40_xNome = fields.Char(string="Razão Social ou Nome do Expedidor/Recebedor", xsd_type="xNomeType70")
    nfe40_xLgr = fields.Char(string="Logradouro", xsd_required=True, xsd_type="xLgrType71")
    nfe40_nro = fields.Char(string="Número", xsd_required=True,xsd_type="nroType72")
    nfe40_xCpl = fields.Char(string="Complemento",xsd_type="xCplType73")
    nfe40_xBairro = fields.Char(string="Bairro", xsd_required=True,xsd_type="xBairroType74")
    nfe40_cMun = fields.Char(string="Código do município", xsd_required=True,xsd_type="TCodMunIBGE",help="Código do município (utilizar a tabela do IBGE)")
    nfe40_xMun = fields.Char(string="Nome do município", xsd_required=True, xsd_type="xMunType75")
    nfe40_UF = fields.Selection(TUF, string="Sigla da UF", xsd_required=True, xsd_type="TUf")
    nfe40_CEP = fields.Char(string="CEP", xsd_type="CEPType76")
    nfe40_cPais = fields.Char(string="Código de Pais",xsd_type="cPaisType77")
    nfe40_xPais = fields.Char(string="Nome do país",xsd_type="xPaisType78")
    nfe40_fone = fields.Char(string="Telefone",xsd_type="foneType79",help="Telefone, preencher com Código DDD + número do telefone , nas"
                                                                          "\noperações com exterior é permtido informar o código"
                                                                          "\ndo país + código da localidade + número do telefone")
    nfe40_email = fields.Char(string="E-mail",xsd_type="emailType80",help="Informar o e-mail do expedidor/Recebedor. O campo pode ser"
...
class TNFe(models.AbstractModel):
    ...
    nfe40_NFe_TEnviNFe_id = fields.Many2one("nfe.40.tenvinfe")
    nfe40_infNFe = fields.Many2one("nfe.40.infnfe", string="Informações da Nota Fiscal eletrônica", xsd_required=True)
    nfe40_infNFeSupl = fields.Many2one("nfe.40.infnfesupl", string="Informações suplementares Nota Fiscal")
...
class AutXML(models.AbstractModel):
    ...
    nfe40_autXML_infNFe_id = fields.Many2one("nfe.40.infnfe")
    nfe40_choice8 = fields.Selection([('nfe40_CNPJ', 'CNPJ'),('nfe40_CPF', 'CPF')],"CNPJ/CPF")
    nfe40_CNPJ = fields.Char(choice='8', string="CNPJ Autorizado", xsd_required=True, xsd_type="TCnpj")
    nfe40_CPF = fields.Char(choice='8', string="CPF Autorizado", xsd_required=True, xsd_type="TCpf")
