...
def post_init_hook(cr, registry):
    ...
    for file in files:
        tools.convert_file(cr,"l10n_br_fiscal",file,None,mode="init",noupdate=True,kind="init")
    ...
    if not tools.config["without_demo"]:
        ...
        for file in posdemofiles:
            tools.convert_file(cr,"l10n_br_fiscal",file,None,mode="demo",noupdate=True,kind="init")
