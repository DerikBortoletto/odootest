...
class AccountMoveLine(models.Model):
    ...
    payment_term_id = fields.Many2one("account.payment.term", related="move_id.invoice_payment_term_id", string="Payment Terms")
    invoice_user_id = fields.Many2one(comodel_name="res.users", related="move_id.invoice_user_id", string="Invoice salesperson", store=True)
