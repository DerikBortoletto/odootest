...
{
    'name': 'Odoo Professional Report Templates For BASIC HMS',
    'version': '14.0.0.3',
    ...
    'depends': ['base', 'account', 'sale', 'purchase', 'stock', 'basic_hms', 'sale_stock', 'base_vat','sale_management','purchase_stock'],
    'data': [
        ...
        "purchase_report/purchase_order.xml",
        ...
        "sale_report/sale_order.xml",

        "security/groups.xml",
        "security/ir.model.access.csv",
        "product_presentation/product_template.xml",
        "product_presentation/product_product.xml",
        "product_presentation/product_presentation.xml",
    ],
    'demo': [],
    'test': [],
    'installable': True,
