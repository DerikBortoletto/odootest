...
class WhatsappTemplates(models.Model):
    ...
    def action_export_template(self):
        ...
        view_ref = self.env['ir.model.data'].get_object_reference('pragtech_whatsapp_base', 'export_template_wizard_form')
        view_id = view_ref and view_ref[1] or False,
        if self.send_template and view_id:
            return {
    ...
    def action_view_gupshup_template(self):
        ...
        view_ref = self.env['ir.model.data'].get_object_reference('pragtech_whatsapp_base', 'whatsapp_gupshup_templates_wizard_form')
        view_id = view_ref and view_ref[1] or False,
        if view_id:
            return {
                'type': 'ir.actions.act_window',
