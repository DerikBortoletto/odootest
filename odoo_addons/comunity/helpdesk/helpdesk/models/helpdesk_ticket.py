...
class HelpdeskTicket(models.Model):
    ...
    def action_open_new(self):
        ...
        menu_id = self.env.ref('helpdesk.helpdesk_ticket_menu_all').id
        record_url = base_url + "/web#id={}&view_type=form&model={}&menu_id={}&action=helpdesk.helpdesk_ticket_action_main_tree".format(
                                str(self.id),self._name,str(menu_id))
        return {
