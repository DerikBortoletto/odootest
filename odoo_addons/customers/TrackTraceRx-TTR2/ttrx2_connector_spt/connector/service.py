...
URI = {
    ...
    'pack.size.type.spt': 'products/packaging_types/{id}',
    ...
    'read.points.spt': 'locations/{location_uuid}/readpoints/{uuid}',
    ...
    'container.spt': 'containers/{container_id_type}/{id}',
    ...
    'stock.picking.outgoing': 'shipments/Outbound/{uuid}',
    'stock.picking.incoming': 'shipments/Inbound/{uuid}',
    'stock.picking.pickings': 'shipments/{uuid}/pickings',
    'stock.picking.verified': 'shipments/{shipment_type}/{uuid}/set_shipment_verified',
    'stock.picking.shipped': 'shipments/{shipment_type}/{uuid}/set_shipment_shipped',
    'stock.picking.received': 'shipments/{shipment_type}/{uuid}/set_shipment_received',
    'stock.picking.approve': 'shipments/{shipment_type}/{uuid}/approve_shipment',
    'stock.picking.serials': 'shipments/{shipment_type}/{shipment_uuid}/products/{product_uuid}/serials',
    'stock.picking.receiving': 'shipments/receiving/{uuid}',
    'stock.picking.receiving.items': 'shipments/picking/{uuid}/items',
    'picking.spt': 'shipments/picking/{uuid}',
    'picking.spt.to_pick': 'shipments/picking/to_pick/{shipment_uuid}',
    'picking.spt.pick_close': 'shipments/picking/{shipment_picking_uuid}/pick_and_close',
    'queue.spt': 'queue/{uuid}',
}
