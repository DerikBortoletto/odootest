...
class format_of_copy_outbound_shipment_to_custom_2nd_party(models.Model):
    _name = 'format.of.copy.outbound.shipment.to.custom.2nd.party'
    _description = 'format_of_copy_outbound_shipment_to_custom_2nd_party'
