...
class copy_epcis_commission_and_decommission_custom_2nd_party(models.Model):
    _name = 'copy.epcis.commission.and.decommission.custom.2nd.party'
    _description = 'copy_epcis_commission_and_decommission_custom_2nd_party'
