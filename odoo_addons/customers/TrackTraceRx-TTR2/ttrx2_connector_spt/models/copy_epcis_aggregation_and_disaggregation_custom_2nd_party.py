...
class copy_epcis_aggregation_and_disaggregation_custom_2nd_party(models.Model):
    _name = 'copy.epcis.aggregation.and.disaggregation.custom.2nd.party'
    _description = 'copy_epcis_aggregation_and_disaggregation_custom_2nd_party'
