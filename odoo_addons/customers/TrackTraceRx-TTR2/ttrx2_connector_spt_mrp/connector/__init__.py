...
class TrackTraceApi2(object):
    _queries_words = ['sort_by','sort_by_asc','nb_per_page','page','licence_type_id','value']
    ...
    def _make_request(self, method, resource, headers=None, params={}, queries={}, data={}):
        ...
        if method in [service.METHOD_POST,service.METHOD_PUT] and not bool(data):
            msg.append('Inform the Data values')
        ...
        if len(msg) == 0:
            ...
            try:
                _logger.debug('>>> Uri TTRx %s' % api_url)
