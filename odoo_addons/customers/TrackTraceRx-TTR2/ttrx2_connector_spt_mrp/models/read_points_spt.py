...
from odoo.addons.tracktrace2_odoo_connector_spt.tools import CleanDataDict, DateTimeToOdoo, DateToOdoo, StrToFloat
...
class read_points_spt(models.Model):
    ...
    _order = 'name'
    _TTRxKey = 'uuid'
    _OdooToTTRx = {'location_uuid': 'location_uuid', 'uuid': 'readpoint_uuid'}
