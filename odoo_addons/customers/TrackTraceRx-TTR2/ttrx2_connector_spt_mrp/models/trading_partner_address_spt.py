...
class trading_partner_address_spt(models.Model):
    ...
    manufacture_sp_id = fields.Char(compute="_compute_uuid", store=False)
    ...
    def _compute_uuid(self):
        for reg in self:
            ...
            reg.manufacture_sp_id = reg.manufacturer_id.tt_id
    ...
    def FromOdooToTTRx(self, values={}):
        ...
        var = {
            ...
            'address_gs1_id': values.get('gs1_id',self.gs1_id),
            'address_nickname': values.get('address_nickname',self.address_nickname),
            'recipient_name': values.get('recipient_name',self.recipient_name),
            'line1': values.get('line1',self.line1),
            'line2': values.get('line2',self.line2),
            'line3': values.get('line3',self.line3),
            'line4': values.get('line4',self.line4),
            ...
            'address_ref': values.get('address_ref',self.address_ref),
    ...
    def UpdateCreateResPartner(self, connector, response, data):
        ...
        var = {
            ...
            'company_type': 'person',
            'uuid': self.uuid,
            'name': self.address_nickname,
            'parent_id': partner_id,
            'friendly_name': self.recipient_name,
            'street': self.line1,
            'street2': self.line2,
            'city': self.city,
            'zip': self.zip,
